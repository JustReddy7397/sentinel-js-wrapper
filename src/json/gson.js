...
exports.TSonArguments = exports.TSonSerializable = exports.toJson = exports.fromJson = exports.IncompatibleSchemaError = void 0;
...
function fromJson(theClass, json) {
    ...
    for (let i = 0; i < keys.length; i++) {
        ...
        if (objectType === "object" && Reflect.getMetadata("isTsonSerializable", constructorType)) {
            ...
            if (basicMappings[objectType] !== constructorType) {
