...
class PlatformController extends Controller_1.default {
    constructor(baseUrl) {
    ...
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield new RequestBuilder_1.default()
                .setQuery(new QueryBuilder_1.default(this.baseUrl).build()).build().getResponse();
            if ((response === null || response === void 0 ? void 0 : response.getType) === "SUCCESS") {
                return response.getResult("platforms", String);
            }
            else {
